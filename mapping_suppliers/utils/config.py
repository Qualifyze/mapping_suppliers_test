...
class MappingConfig:
    def __init__(self,
        ...
        self.source_1_mapping_column_cleaned = f"{source_1_prefix}_mapped_substance_cleaned"
        self.source_2_mapping_column_cleaned = f"{source_2_prefix}_mapped_substance_cleaned"
...
possible_mappings : list[MappingConfig] = [
    ...
    MappingConfig(
        source_1_filename="a57_raw.csv",
        source_1_id="Active_substance",
        source_1_prefix="A57",
        source_1_separator=",",
        source_2_filename="cep_raw.csv",
    ...
    MappingConfig(
        source_1_filename="us_dmf.csv",
        source_1_id="HOLDER",
        source_1_prefix="US_DMF",
        source_1_separator=None,
        source_2_filename="qf_supplier_sites.csv",
        source_2_id="ceapp_supplier_site_name",
        source_2_prefix="QF",
        source_2_separator=None,
        mapping_name="supplier_us_dmf_to_qf",
    ...
    MappingConfig(
        source_1_filename="cep_raw.csv",
        source_1_id="certificateHolder",
        source_1_prefix="CEP",
        source_1_separator=None,
        source_2_filename="qf_supplier_sites.csv",
        source_2_id="ceapp_supplier_site_name",
        source_2_prefix="QF",
        source_2_separator=None,
        mapping_name="supplier_cep_to_qf",
        mapping_type=MappingType.SUPPLIER,
        fuzzy_match_threshold=50,
        cleaned_fuzzy_match_threshold=50,
        request_item_size=100,
    ...
    MappingConfig(
        source_1_filename="hikma_union_usa_europe.csv",
        source_1_id="supplier_offered_api",
        source_1_prefix="PUBLIC",
        source_1_separator=None,
        source_2_filename="qf_supplier_sites_full.csv",
        source_2_id="qf_supplier_site_audited_requested_product",
        source_2_prefix="QF",
        source_2_separator=None,
        mapping_name="substance_hikma_to_qf",
        mapping_type=MappingType.SUBSTANCE,
        fuzzy_match_threshold=70,
        cleaned_fuzzy_match_threshold=80,
        request_item_size=100,
    ...
    MappingConfig(
        source_1_filename="hikma_usa_all_sites.csv",
        source_1_id="OB_supplier",
        source_1_prefix=None,
        source_1_separator=None,
        source_2_filename="substance_orange_book_to_usdmf_merged_all.csv",
        source_2_id="US_DMF_HOLDER",
        source_2_prefix=None,
        source_2_separator=None,
        mapping_name="hikma_usa",
        mapping_type=MappingType.MERGE,
        fuzzy_match_threshold=None,
        cleaned_fuzzy_match_threshold=None,
        request_item_size=None,
        batch_size=None,
    ),
    MappingConfig(
        source_1_filename="hikma_europe_all_sites.csv",
        source_1_id="CEP_suppliers",
        source_1_prefix=None,
        source_1_separator=None,
        source_2_filename="cep_final_output_all.csv",
        source_2_id="CEP_certificateHolder",
        source_2_prefix=None,
        source_2_separator=None,
        mapping_name="hikma_europe",
        mapping_type=MappingType.MERGE,
        fuzzy_match_threshold=None,
        cleaned_fuzzy_match_threshold=None,
        request_item_size=None,
    ...
    MappingConfig(
        ...
        source_1_prefix="PUBLIC",
        source_1_separator=None,
        source_2_filename="qf_supplier_names.csv",
        source_2_id="supplier_name",
        source_2_prefix="QF",
        source_2_separator=None,
